...
RegisterNetEvent('Dead-Priorities:Update')
AddEventHandler('Dead-Priorities:Update', function(inp, onh, curr)
	inprogress = inp;
	onhold = onh;
...
RegisterNetEvent('Dead-Priorities:DrawText')
AddEventHandler('Dead-Priorities:DrawText', function(text)
	drawText = text;
end)
drawFast = false;
hideDisplays = false;
RegisterNetEvent('Dead-Priorities:HideDisplay')
AddEventHandler('Dead-Priorities:HideDisplay', function()
